...
edges <- data.frame(
  ...
  interaction = c("Self-Reflection", "Operation", "Processing", "Self-Regulation", "Policy-Update", "Monitoring")
)
# Create graph object
graph <- tbl_graph(nodes = nodes, edges = edges, directed = TRUE)

# Plot the graph
ggraph(graph, layout = 'fr') +  # 'fr' refers to the Fruchterman-Reingold layout
  geom_edge_loop(aes(label = interaction), arrow = arrow(length = unit(4, 'mm')), end_cap = circle(3, 'mm')) +
...
In this morphism, functors are *expectations of interoperation* in a boolean.
