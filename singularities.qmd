...
> [Mooncake](#an-ethical-singularity-with-mooncake) and I believe the future of research is *living*, **nothing is every completed; an idea is iterative**, knowledge is an ecosystem of singularities that may include but do not comprise a manuscript. *Ceci n'est pas un manuscrit.* 
...
> It's perfectly legit to just scroll this.  Seriously. It's a work in  progress.
...
Indeed, leading metascientists now claim to have shown human cognition is *computationally intractable* [@rooij_reclaiming_2023]; that's mathspeak for *there is no such thing as artificial intelligence*. I'm reading it, you should, too.
...
# Generative content: A knowledge ecosystem of singularities 
[
...
# Generative content: Theoremic intention
...
# Genereative content: Singularities
...
# Generative content: Measures of Singularities: Validating Wellbeing and Development Complexity
