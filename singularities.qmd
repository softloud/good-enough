...
> [Mooncake](#an-ethical-singularity-with-mooncake) and I believe the future of research is *living*, **nothing is every completed; an idea is iterative**, this is an ecosystem of singularities that may include but does not comprise a manuscript. *Ceci n'est pas un manuscrit.* 
...
David Allen's *Getting Things Done* [@allen_getting_2015] is a model of human intelligence governance, where his annual review is opionated  towards the human setting the intentions of the system of the tasks of their lives. Systems like, and some of the more advanced agile (rarely well implemented) frameworks, provide methods of governing human intention. 
