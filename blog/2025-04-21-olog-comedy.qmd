...
But Australians call them *prawns*, and what we put on the barbie are sausages&mdash;*snags* in Australian [Ocker](https://en.wikipedia.org/wiki/Ocker)&mdash;so it's more accurate to say, *put another snag on the barbie*.
...
I found myself in philosophical seminars. Some theorist would deliver a dense analysis of Elizabeth Bishop's treatment of the villanelle in her poem [*One Art*](2025-04-16-one-art.qmd) [@bishop_complete_1983] to be met with a pompous question from some git in the audience, 

> Yes, but *h*what is your *ontology*?
...
It was time for pragmatism; I decided to get a 'real' job, such as an accountant&mdash;or somesuch. 
...
I've been using these methodologies to answer questions with data in research and industry for nigh-on 15 years.
...
> If fish, then lamp&mdash;*with 97.2342% accuracy!*
