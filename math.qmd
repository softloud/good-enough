...
The digraph $I$ of intelligence governance is a minimal representation of a discrete topological dynamical system that governs emergence for human wellbeing in a structured intelligence system. 
...
A singularity in which virtuous E $\gg$ miscreant E, i.e., $\varepsilon_v \gg \varepsilon_m$, where burn rate (measure of steps completed to estimated time) is above a certain $\theta$ threshold.

## Definition: Miscreant singularity

A singularity in which miscreant E $\gg$ virtuous E, i.e., $\varepsilon_m \gg \varepsilon_v$, where burn rate (measure of steps completed to estimated time) is below a certain $\theta$ threshold.
