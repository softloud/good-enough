...
2. Define $I$ as a digraph.
3. Show $I$ is a discrete topological dynamical system.
4. Show how $I$ governs emergence in a structured intelligence system.
...
Define a metric on $I$ that aggregates the emergence of a structured intelligence system 

$$
E = \alpha \cdot n + \alpha \cdot t
$$

where $n$ denotes the periodicity of the cycle in $I$, and $t$ denotes the time elapsed.
...
# Conjecture: The modern data stack is violation of the three laws
