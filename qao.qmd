...
digraph G {
  ...
  subgraph cluster_data {
    ...
    output [label="analytical observation"]
    analysis [color=red]
...
Structured Intelligencee System of a Questionable Analytical Observation. If the analyst does not adequately define the desired analytical observation, then the analysis is spurious.
