...
It's time I said something from my [expertise and experience](https://www.linkedin.com/in/charles-t-gray/). We will explore different fields that do not get enough attention in how to design systems that care about people.
...
This means the system cares about people *by design*.
:::

So that people and computational tools can interoperate for chaotic good. 

And we can't expect people to be best [@wilson_best_2014], we need to start with good enough [@wilson_good_2017]. And to know if they've done a good enough job? They need a **score** to follow, analogous to what a session musicians require.

tl;dr $\to$ table of contents. 

::: {.callout-tip title="Good Enough Soundtrack"}
Otherwise, strap in, put the soundtrack[^7] on, and read an [Undisciplined take](https://undisciplinedenvironments.org/2019/10/01/undisciplining-political-ecology-a-minifesto/). 

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/155tTRTI5ttHtcWJqlprFF?utm_source=generator&theme=0" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
:::
...
It's time for some [grrl talk](../blog/2025-07-09-paradox.qmd) on "ethical AI". 
:::
...
Asimov is proposed governance lawes for automata, that is, robots [@asimov_i_1950].  
...
The oft-considered boring bits of data science---not the statistical algorithm applied (e.g., regression, random forests, natural language processing, image classification)---that is, documentation and tests, are where we have most mathematically and ethically challenging problems.
...
CT people, your math is plenty developed—it's imperative the mathematically literate make it useful to those with less formal training. We need dimension-reducing ways of measuring the validity of computational systems of inquiry urgently[^8].
:::
...
This yaml can then be linked on a branch via a kanban ticket, with pull-request tagged with ticket number. 
...
Jazz musicians improvise, however, they follow a score made of predictably structured phrases, for example, a $II-V-I$ progression in the dominant, then the tonic, $\to II/V \to V/V \to I/V \to I/V \to II \to V \to I \to I \to$. However, a classical musician might think of a $II-V-I$ in terms of a composition of interrupted cadence and perfect cadence, first in the dominant, then the tonic.
...
Except, of course the assumption that:
